...
public class ShooterDistanceToRpmConverterTest extends BaseCompetitionTest {
    ...
    public void testConverter() {
        ...
        assertEquals(500, converter.getRPMForDistance(1).upperWheelsTargetRPM, 0.00001);
        assertEquals(3500, converter.getRPMForDistance(11).upperWheelsTargetRPM, 0.00001);
        assertEquals(2200, converter.getRPMForDistance(6).upperWheelsTargetRPM, 0.00001);

        //testing when distance is in between two points in the recorded data
        assertEquals(725,converter.getRPMForDistance(1.5).upperWheelsTargetRPM,0.00001);
        assertEquals(2850,converter.getRPMForDistance(9).upperWheelsTargetRPM,0.00001);
        ...
        assertEquals(0,converter.getRPMForDistance(0.5).upperWheelsTargetRPM,0.00001);
        assertEquals(0,converter.getRPMForDistance(200).upperWheelsTargetRPM,0.00001);
        assertEquals(0,converter.getRPMForDistance(-192391).upperWheelsTargetRPM,0.00001);
