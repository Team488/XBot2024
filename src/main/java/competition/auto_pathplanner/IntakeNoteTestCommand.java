...
public class IntakeNoteTestCommand extends BaseCommand {
    ...
    @Inject
    public IntakeNoteTestCommand(PathPlannerDriveSubsystem drive, RobotContainer robotContainer,
        ...
        this.autonomousCommand = robotContainer.getIntakeNoteTestCommand();
