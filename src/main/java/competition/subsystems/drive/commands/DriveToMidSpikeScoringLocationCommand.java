...
public class DriveToMidSpikeScoringLocationCommand extends SwerveSimpleTrajectoryCommand {

    DynamicOracle oracle;
    DriveSubsystem drive;

    @Inject
    public DriveToMidSpikeScoringLocationCommand(DriveSubsystem drive, DynamicOracle oracle,
